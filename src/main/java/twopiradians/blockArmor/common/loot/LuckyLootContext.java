...
public final class LuckyLootContext {
    ...
    public static void push(LootContext context) {
		Object killer = context.getOptionalParameter(LootContextParams.ATTACKING_ENTITY);
        Object victim = context.getOptionalParameter(LootContextParams.THIS_ENTITY);
    ...
    public static int adjust(int original, LivingEntity entity) {
        ...
        if (frame == null || !(entity instanceof Player) || frame.killer != entity || frame.victim == null
